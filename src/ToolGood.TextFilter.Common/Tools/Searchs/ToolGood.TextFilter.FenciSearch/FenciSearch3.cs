...
using ToolGood.TextFilter.Common.Datas.TextFilters;

namespace ToolGood.TextFilter
{
    public interface IFenciSearch 
    {
        void Set_GetMatchKeyword(Func<int, FenciKeywordInfo> func);
    ...
    class FenciSearch3 : IFenciSearch
    {
        ...
        private Func<int, FenciKeywordInfo> _getKeyword;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Set_GetMatchKeyword(Func<int, FenciKeywordInfo> func)
        {
            _getKeyword = func;
        }
        #endregion
